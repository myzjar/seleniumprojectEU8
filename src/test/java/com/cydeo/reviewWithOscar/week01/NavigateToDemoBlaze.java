...
public class NavigateToDemoBlaze {
    ...
    public static void main(String[] args) {
        ...
        // taxi car: browser-Chrome, taxiDriver: Selenium Webdriver - who can drive this car
      ...
      //  driver.navigate().to("https://www.demoblaze.com/index.html");
        ...
        //As a tester, without of verification/validation what is your VALUE to the Company
